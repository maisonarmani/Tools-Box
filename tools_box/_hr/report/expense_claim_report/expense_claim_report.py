...
def execute(filters=None):
    ...
    columns = ["Date:Date:100", "Doc ID:Link/Expense Claim:150", "Expense Claim Type:Link/Expense Claim Type:100",
               "Description:Text:200", "Amount:Currency:150", "Approver:Link/User:200"]
    ...
    data = frappe.db.sql(
        "SELECT d.expense_date,p.name,d.expense_type,d.description,d.sanctioned_amount,p.exp_approver {0} FROM "
